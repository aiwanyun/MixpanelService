//
//  MixpanelServiceTableViewController.swift
...
final class MixpanelServiceTableViewController: UITableViewController, UITextFieldDelegate {
    ...
    private let service: MixpanelService
    
    private let operation: Operation
    
    init(service: MixpanelService, for operation: Operation) {
